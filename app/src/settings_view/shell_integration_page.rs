...
pub fn init_actions_from_parent_view<T: Action + Clone>(
        ...
        .is_supported_on_current_platform()
    {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            ...
            builder(SettingsAction::ShellIntegrationPageToggle(
                ShellIntegrationPageAction::ToggleSshWarpification,
            )),
            context,
...
const SSH_REUSE_CONTROL_MASTER_DESCRIPTION: &str = "Attach to a live SSH ControlMaster you already have configured for the destination host instead of creating our own. Takes effect in new tabs.";
...
pub struct ShellIntegrationPageView {
    page: PageType<Self>,
    ...
    ssh_extension_install_mode_dropdown: ViewHandle<Dropdown<ShellIntegrationPageAction>>,
}

impl ShellIntegrationPageView {
            ...
            .is_supported_on_current_platform()
        {
            categories.push(
                Category::new("SSH", vec![Box::new(SSHWidget::default())])
                    .with_subtitle("Enable shell integration for your interactive SSH sessions."),
            );
        }
        ...
        self.ssh_extension_install_mode_dropdown
            .update(ctx, |dropdown, ctx| {
                dropdown.set_selected_by_action(
                    ShellIntegrationPageAction::SetSshExtensionInstallMode(current_mode),
                    ctx,
                );
            });
    }
...
impl Entity for ShellIntegrationPageView {
...
impl ShellIntegrationPageView {
    fn create_ssh_extension_install_mode_dropdown(
        ctx: &mut ViewContext<Self>,
    ) -> ViewHandle<Dropdown<ShellIntegrationPageAction>> {
        let items: Vec<DropdownItem<ShellIntegrationPageAction>> = SshExtensionInstallMode::iter()
            .map(|mode| {
                DropdownItem::new(
                    mode.display_name(),
                    ShellIntegrationPageAction::SetSshExtensionInstallMode(mode),
                )
            })
            .collect();
...
impl View for ShellIntegrationPageView {
    fn ui_name() -> &'static str {
        "ShellIntegrationPageView"
    }
...
pub enum ShellIntegrationPageAction {
...
impl TypedActionView for ShellIntegrationPageView {
    type Action = ShellIntegrationPageAction;

    fn handle_action(&mut self, action: &Self::Action, ctx: &mut ViewContext<Self>) {
        use ShellIntegrationPageAction::*;
        match action {
...
impl SettingsPageMeta for ShellIntegrationPageView {
...
impl From<ViewHandle<ShellIntegrationPageView>> for SettingsPageViewHandle {
    fn from(view_handle: ViewHandle<ShellIntegrationPageView>) -> Self {
        SettingsPageViewHandle::ShellIntegration(view_handle)
    }
}
...
impl SettingsWidget for TitleWidget {
    type View = ShellIntegrationPageView;
    ...
    fn render_subshells_section(
        ...
        column.add_child(
            view.build_input_list(
                ...
                ShellIntegrationPageAction::RemoveAddedCommand,
        ...
        column.add_child(
            view.build_input_list(
                ...
                ShellIntegrationPageAction::RemoveDenylistedCommand,
...
impl SettingsWidget for SSHWidget {
    ...
    fn render(
        ...
        add_setting(
            ...
            move || {
                render_body_item::<ShellIntegrationPageAction>(
                    "Shell integration for SSH sessions".into(),
                    None,
        ...
        add_setting(
            ...
            move || {
                let mut column = Flex::column();
                column.add_child(render_body_item::<ShellIntegrationPageAction>(
                    ...
                    ui_builder
                        ...
                        .on_click(move |ctx, _, _| {
                            ...
                            ctx.dispatch_typed_action(
                                ShellIntegrationPageAction::ToggleReuseSshControlMaster,
                            );
                        })
                        .finish(),
                    None,
