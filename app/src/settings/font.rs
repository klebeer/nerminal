...
define_settings_group!(FontSettings,
    settings: [
        ...
        fallback_font_family: FallbackFontFamily {
            type: String,
            default: String::new(),
            ...
            surface: settings::SettingSurfaces::GUI,
            private: false,
            toml_path: "appearance.text.fallback_font_family",
            description: "The font family used for glyphs the monospace font does not have. Empty leaves the system fallback chain untouched.",
        },
