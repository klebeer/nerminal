...
define_settings_group!(CodeSettings, settings: [
    code_as_default_editor: CodeAsDefaultEditor {
        ...
        description: "Whether Nerminal is used as the default code editor.",
    }
    ...
    auto_save: AutoSave {
        ...
        description: "Whether the built-in text editor automatically saves changes as you type and when the editor loses focus.",
    },
]);
