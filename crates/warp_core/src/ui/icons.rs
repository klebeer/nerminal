...
pub enum Icon {
    ...
    /// `bundled/svg/nerminal.svg`). The background and tint color are
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::WarpDrive => "bundled/svg/nerminal.svg",
            Icon::Warp => "bundled/svg/nerminal.svg",
            Icon::WarpLogoLight => "bundled/svg/nerminal.svg",
            ...
            Icon::Warping0 => "bundled/svg/nerminal-loading-0.svg",
            Icon::Warping1 => "bundled/svg/nerminal-loading-1.svg",
            Icon::Warping2 => "bundled/svg/nerminal-loading-2.svg",
            Icon::Warping3 => "bundled/svg/nerminal-loading-3.svg",
            Icon::Warping4 => "bundled/svg/nerminal-loading-4.svg",
            Icon::Warping5 => "bundled/svg/nerminal-loading-5.svg",
            Icon::Warping6 => "bundled/svg/nerminal-loading-6.svg",
            Icon::Warping7 => "bundled/svg/nerminal-loading-7.svg",
            Icon::Warping8 => "bundled/svg/nerminal-loading-8.svg",
            Icon::Warping9 => "bundled/svg/nerminal-loading-9.svg",
            Icon::Warping10 => "bundled/svg/nerminal-loading-10.svg",
            Icon::Warping11 => "bundled/svg/nerminal-loading-11.svg",
            ...
            Icon::Oz => "bundled/svg/nerminal.svg",
            Icon::Agent => "bundled/svg/nerminal.svg",
