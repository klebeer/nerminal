...
use warp::integration_testing::notebook::{
    ...
    assert_open_in_nerminal_banner_open, create_a_personal_notebook,
...
pub fn test_open_in_nerminal_banner() -> Builder {
    new_builder()
        .with_setup(|utils| {
        ...
        .with_step(
            ...
            .add_assertion(assert_open_in_nerminal_banner_open(0, 0)),
        )
        .with_step(
            new_step_with_default_assertions("Click Open in Warp banner")
                .with_click_on_saved_position_fn(|app, window_id| {
                    ...
                    format!("open_in_nerminal_banner_button_{}", view.id())
                }),
        )
        .with_step(
